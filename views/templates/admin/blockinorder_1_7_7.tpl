                            ...
                            <div class="itella-services d-flex justify-content-between">
                                ...
                                <label class="checkbox-inline" {if !$is_available} style="opacity:0.3;" {/if}>
                                    <input type="checkbox" value="is_oversized" name="itella_extra[]" {if
                                        $orderItellaCartInfo.is_oversized} checked="checked" {/if}{if !$is_available} disabled="disabled" {/if}>
                                ...
                                <label class="checkbox-inline" {if !$is_available} style="opacity:0.3;" {/if}>
                                    <input type="checkbox" value="is_call_before_delivery" name="itella_extra[]" {if
                                        $orderItellaCartInfo.is_call_before_delivery} checked="checked" {/if}{if !$is_available} disabled="disabled" {/if}>
                                ...
                                <label class="checkbox-inline" {if !$is_available} style="opacity:0.3;" {/if}>
                                    <input type="checkbox" value="is_fragile" name="itella_extra[]" {if
                                        $orderItellaCartInfo.is_fragile} checked="checked" {/if}{if !$is_available} disabled="disabled" {/if}>
                                ...
                                <label class="checkbox-inline" id="multi_parcel_chb" {if !$is_available} style="opacity:0.3;" {/if}>
                                    <input type="hidden" id="itella-multi" name="itella_extra[]" value="is_multi"
                                        disabled="disabled">
                                    <input disabled="disabled" type="checkbox" {if $is_available} checked {/if}>
