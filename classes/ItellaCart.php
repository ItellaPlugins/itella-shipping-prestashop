...
class ItellaCart
{
  ...
  public function saveOrder($orderObj)
  {
    ...
    $cart = array(
      ...
      'is_cod' => (in_array($orderObj->module, $cod_modules) && $is_pickup == 0) ? 1 : 0,
      'cod_amount' => $is_pickup == 0 ? $orderObj->total_paid_tax_incl : 0,
      'is_pickup' => $is_pickup,
      'label_number' => '',
      'is_oversized' => 0,
  ...
  public function updateItellaCart()
  {
    ...
    $cart = array(
      ...
      'weight' => pSQL($weight),
      'volume' => pSQL($volume),
      'is_cod' => $is_pickup == 0 ? pSQL($is_cod) : 0,
      'cod_amount' => $is_pickup == 0 ? pSQL($cod_amount) : 0,
